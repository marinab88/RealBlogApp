                ...
                <p className="post_datestamp"><b>{moment(datestamp).fromNow()}</b></p>                
                    <div className="post_button">
                        <ul className="buttons">
                            <li><Link to={`/post/${id}`} className="btn btn-outline-primary"> Show </Link></li>
                            <li><Link to={`/edit/${id}`} className="btn btn-outline-warning"> Edit </Link></li>
                            <li><Link onClick={this.confirmDeletion} className="btn btn-outline-danger">Delete</Link></li>
                        </ul>
                    </div>                   
            </Paper>
         );
